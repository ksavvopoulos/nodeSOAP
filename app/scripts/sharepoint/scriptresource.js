...
Sys.Serialization.JavaScriptSerializer._serializeWithBuilder = function (b, a, i, g) {
	...
	case "object":
		...
		if (Boolean.isInstanceOfType(b)) Sys.Serialization.JavaScriptSerializer._serializeBooleanWithBuilder(b, a);
...
Sys._ScriptLoaderTask.prototype = {
	...
	_addScriptElementHandlers: function () {
		...
		else $addHandler(this._scriptElement, "load", this._scriptLoadDelegate); if (this._scriptElement.addEventListener) {
	...
	_removeScriptElementHandlers: function () {
		if (this._scriptLoadDelegate) {
			...
			else $removeHandler(a, "load", this._scriptLoadDelegate); if (this._scriptErrorDelegate) {
